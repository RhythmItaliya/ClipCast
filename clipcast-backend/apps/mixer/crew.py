...
VENDORED COPY of `clipcast-backend/crew/agents.py` (the canonical, CPU-tested
source) so it ships inside this app's isolated Modal image. Keep in sync with
the canonical module; behaviour is covered by `crew/test_crew.py`.
