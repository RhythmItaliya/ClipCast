      ...
      >
        ...
        <aside className="space-y-4">
              ...
              {recentClips.length === 0 ? (
                ...
                recentClips.map((c) => (
                  <Link
                    ...
                    className="bg-background/50 hover:bg-surface-2 flex items-center gap-3 rounded-xl p-2.5 transition-colors"
                  >
          ...
          <Link
            ...
            className="group border-border bg-surface/60 hover:bg-surface-2 flex items-center gap-3 rounded-3xl border p-4 transition-colors"
          >
